/* prints_crime_occurences_late_august.js
 * Author: Guillermo K. Rojas
 * Date: 7/29/14 Modified: 8/26/14
 * 
...
/*Generates text for layers control*/
		...
		var assaultText = "Assault (" + listOfAssault.length.toString() + ")";
			...
			criminalTrespassText = "Criminal Trespass Layer (" + listOfCriminalTrespass.length.toString() + ")";
		...
		console.log(criminalTrespassText);
...
/*End of .js that generates console output for number of each type of crime */